        ...
        <div class="row no-gutters align-items-center pt-60px">
          ...
          <div class="col-sm-7 col-lg-6 offset-lg-1 pl-4 pl-md-5 pl-lg-0">
            <div class="hero-banner__content">
              <h4>Service AC Mudah</h4>
              <h1>Bergabung dengan kami sekarang</h1>
              <p>Pilih layanan service AC anda sendiri</p>
              <a class="button button-hero" href="login.html">Masuk / Daftar</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="owl-carousel owl-theme hero-carousel">
        <div class="hero-carousel__slide">
          ...
          <a href="#" class="hero-carousel__slideOverlay">
            <h3>Tenaga yang Berpengalaman</h3>
          </a>
        </div>
        <div class="hero-carousel__slide">
    ...
    <section class="section-margin calc-60px">
      <div class="container">
        <div class="section-intro pb-60px">
          <p>Layanan Service Populer</p>
          <h2>Layanan Service <span class="section-intro__style">AC</span></h2>
        </div>
        <div class="row">
    ...
    <section class="subscribe-position">
      <div class="container">
        <div class="subscribe text-center">
          <h3 class="subscribe__title">Dukung kami</h3>
          <p>Dukung kami dengan subscribe</p>
